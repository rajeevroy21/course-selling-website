...
const Hero = () => {
  return (
    ...
    0x-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        <h1 className='md:text-home-heading-large text-home-heading-small relative
        font-blod text-gray-800 max-w-3xl mx-auto'>Unlock your potential with personalized learning at  <span className='text-blue-600'>your pace.</span>
